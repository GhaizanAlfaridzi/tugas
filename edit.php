    ...
    if (isset($_POST['update'])) {
        ...
        if (empty($_POST['firstname']) || empty($_POST['lastname']) ||
            ...
            if ($con->query($sql) === TRUE) {
                ...
                echo "<div class='alert alert-danger'>Error: There was an error update user</div>";
            }
        }
    }
        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="box">
                ...
                <form action="" method="POST">
                    ...
                    <textarea name="address" rows="4" class="form-control"><?php echo $row['address']; ?></textarea><br>
